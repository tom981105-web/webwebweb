...
export function ModalShell({ open, title, description, onClose, footer, children }: ModalShellProps) {
  ...
  return (
    <div className="rg-fixed rg-inset-0 rg-z-50 rg-flex rg-items-center rg-justify-center rg-bg-slate-950/78 rg-px-4 rg-py-8">
      <div className="rg-absolute rg-inset-0" onClick={onClose} />
      <div className="rg-relative rg-w-full rg-max-w-3xl rg-overflow-hidden rg-rounded-[32px] rg-border rg-border-white/10 rg-bg-[linear-gradient(180deg,rgba(15,20,34,0.98),rgba(10,14,25,0.98))] rg-shadow-card">
        <div className="rg-flex rg-items-start rg-justify-between rg-gap-4 rg-border-b rg-border-white/8 rg-px-6 rg-py-5">
          ...
          <button
            type="button"
            onClick={onClose}
            className="rg-rounded-full rg-border rg-border-white/10 rg-bg-white/5 rg-px-4 rg-py-2 rg-text-xs rg-font-semibold rg-text-slate-200"
          >
            닫기
          </button>
        </div>
